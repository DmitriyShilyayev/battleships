...
function fieldCellClicked() {
    let cell = $(this),
        ...
        shipRow = $('.ship-row.selected'),
        amountLeft = shipRow.data('amount'),
        shipLength = shipRow.data('length'),
        fieldCells = $('#starting-screen .field-cell');
    if (
        checkAvailability(
            cellRow,
            cellColumn,
...
// Инициализация кнопки случайной расстановки кораблей
